...
import flc.social.process.Quickstart;
import flc.social.process.YoutubeDataRetriever;
...
public class YoutubeDataService {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                YoutubeDataService.class.getResourceAsStream("/youtube_client_secret.json");
